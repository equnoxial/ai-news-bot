...
def get_ai_post(title):
    ...
    prompt = (
        f"Новость: {title}\n"
        "Напиши пост для Telegram на русском: заголовок (не пиши вначале новость: а сразу начиннай с заголовка) + 4-6 коротких простых предложений + 1 риторический вопрос в конце в отдельном абзаце. "
